...
if args.function == 'pretrain':
    ...
    train = trainer.Trainer(model, pretrain_dataset, None, tconf)
    train.train()
    ...
    ### YOUR CODE HERE ###
    datasets = dataset.NameDataset(pretrain_dataset, data=open(args.finetune_corpus_path, encoding='utf-8').read())
    ...
    train = trainer.Trainer(model, datasets, None, tconf)
    train.train()
    torch.save(model.state_dict(), args.writing_params_path)
    pass
    ### END YOUR CODE ###
